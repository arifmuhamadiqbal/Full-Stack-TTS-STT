...
const Main = () => {
  ...
  const [isRecording, setIsRecording] = useState(false); // State untuk merekam
  ...
  const startListening = () => {
    ...
    setIsRecording(true); // Set state ke true ketika mulai merekam
  };
  ...
  const handleStopRecording = () => {
    setIsRecording(false); // Set state ke false ketika berhenti merekam
